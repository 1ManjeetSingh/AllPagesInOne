...
const Aftersalection = () => {
    ...
    return (
        <div className='.main-container min-h-screen bg-[#F1F4F8]'>
            <div className="NavBar w-full h-full px-10 py-2 bg-white border border-[#D2D2D2] backdrop-blur-[220px] flex justify-between items-center hover:cursor-pointer">
                ...
                <div className="Frame1000008205 flex justify-start items-center gap-6 w-fit bg-[#fff]" >
                    <div className="Frame1000008204 px-[16px] py-[2px] bg-[#EBEBEB] flex justify-start items-center shadow-[0px_0px_6px_rgba(0,_0,_0,_0.25)] rounded-[40px] backdrop-blur-[4px]">
                        ...
                        <div className="Profile flex justify-end items-center bg-[#EBEBEB] hover:transform hover:scale-[1.05] hover:transition-transform hover:duration-300" >
                            <img className="AvatarPic w-[36px] min-w-[36px] h-[44px] bg-none rounded-full" src={image3} />
                        </div>
                    </div>
            ...
            <div className='flex flex-col justify-center items-center'>
                <div className="LetsGetYouStarted text-center text-[36px] font-bold leading-[44px] 
      text-[#D388FF] break-words mt-6 mb-4 text-transparent w-[800px]" style={{
                ...
                <div >
                    <div className="toogleContainer w-fit flex bg-gray-200 rounded-full p-1 space-x-4 mt-6" >
                        {/* Non-Technical Button */}

                        <button
                            className={`w-fit p-[8px_24px] text-[16px] flex items-center justify-center rounded-full font-medium transition duration-300 ease-in-out ${selected === "nonTechnical"
                        ...
                        {/* Technical Button */}
                        <button
                            className={`w-fit p-[8px_24px] text-[16px] flex items-center justify-center rounded-full font-medium transition duration-300 ease-in-out ${selected === "technical"
                                ? "bg-gradient-to-r from-blue-500 to-purple-500 text-white focus:outline-none border-none"
                                : "bg-white text-gray-700 focus:outline-none border-none"
                                }`}
            ...
            <div className="flex justify-center items-center relative overflow-hidden pt-12" >
                <Carousel />
            </div>

            {/* ///////////Difficulty Card///////// */}
            <div className='DialogCards w-full flex justify-center gap-10 px-12 my-10'>
                <>
                    {/* Trigger Button (Selection Panel) */}
                    <div
                        className="SelectionPanel hover:transform hover:scale-[1.01]  w-1/4 h-[80px] px-[24px] bg-white rounded-[10px] shadow-[0px_2px_12px_rgba(0,_0,_0,_0.25)] border-[2px] border-[#5C9AFF] inline-flex items-center justify-start gap-[16px] cursor-pointer"
                        onClick={toggleDialogDifficulty}
                    >
                        <div
                            className="Frame1000008202 cursor-pointer flex-[1_1_0] h-[72px] pt-[8px] pb-[8px] justify-start items-center gap-[16px] flex bg-none"
                        >
                            <svg
                ...
                <>
                    ...
                    <div
                        ...
                        className="SelectionPanel hover:transform hover:scale-[1.01]  w-1/4 h-[80px] pl-[24px] pr-[18px] bg-white rounded-[10px] shadow-[0px_2px_12px_rgba(0,_0,_0,_0.25)] border-[2px] border-[#5C9AFF] inline-flex items-center justify-start gap-[16px] cursor-pointer"
                    >
                        <div className="Frame1000008202 cursor-pointer flex-[1_1_0] h-[72px] pt-[8px] pb-[8px] justify-start items-center gap-[16px] flex bg-none" >          <svg className='w-fit bg-none' xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 32 32" fill="none">
            ...
            <div className='flex w-full justify-end px-16 pb-8'>
                <div className=" ButtonsCta max-w-[251px] h-[40px] px-8 py-4 rounded-[30px] justify-center items-center gap-4 inline-flex hover:cursor-pointer bg-question_gradient">
