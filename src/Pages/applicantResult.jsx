    ...
    <div className="bg-[#F7F7F7]">
      ...
      <div className="h-[50%]">
        ...
        <div className="NavBar w-full mx-[auto] h-[8vh] min-h-[42px] px-8 bg-white border border-[#D2D2D2] backdrop-blur-[220px] flex justify-between items-center hover:cursor-pointer">
          ...
          <div className="SearchBarContainer w-full flex grow justify-end pr-[5vw] items-center gap-4 bg-none">
          ...
          <div className="Frame1000008205 flex justify-start items-center gap-[4vh] bg-none" >
          <p className="border border-[#EBEBEB] bg-[#F4F4F4] rounded-full pl-3 pr-1 flex w-[16vw] justify-center items-center">
              <span className="pr-1 text-[2vh]">3 New Notifications</span>
              <div className="ButtonsNotification w-[5vh] min-w-[24px] h-[5vh] min-h-[24px] mr-[0.5vh] relative bg-none" >
                <div className="Ellipse w-[5vh] h-[5vh] min-w-[24px] min-h-[24px] absolute left-0 top-0 bg-none rounded-full" />
            ...
            <div className="Profile flex justify-end items-center bg-none hover:transform hover:scale-[1.08] hover:transition-transform hover:duration-300" >
                <img className="AvatarPic w-[5vh] min-w-[24px] bg-none rounded-full" src={image3} />
              </div>
            <div className="text-[#353535] text-[2.5vh] max-text-[18px] font-medium leading-[2.5vh] w-[16vh]">
              Neha Yadav
            </div>
