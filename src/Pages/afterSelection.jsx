    ...
    return (
      ...
      text-[#D388FF] break-words mt-[4vh] mb-[2.5vh] text-transparent w-[95vw] md:w-[78vw] lg:w-[65vw]" style={{
                            ...
                            >
                                ...
                                >
                                    <svg
                                        ...
                                        style={{width: 'clamp(24px,2.5vh,2.5vh)',height: 'clamp(24px,2.5vh,2.5vh)'}}
                                        viewBox="0 0 32 34"
                                        fill="none"
                                    >
                                        <path
                        ...
                        <>
                            ...
                            >
                                <div className="Frame1000008202 cursor-pointer flex-[1_1_0] h-[11vh] py-[2vh] justify-start items-center gap-2 md:gap-[16px] flex bg-none" >         
                                 <svg className='w-fit bg-none' xmlns="http://www.w3.org/2000/svg" style={{width: 'clamp(24px,2.5vh,2.5vh)',height: 'clamp(24px,2.5vh,2.5vh)'}} viewBox="0 0 32 32" fill="none">
                    ...
                    <div className='flex w-full justify-end px-[2vw] pb-4'>
                        <div className=" ButtonsCta h-[6vh] px-4 py-4 rounded-[30px] justify-center items-center gap-4 inline-flex hover:cursor-pointer bg-question_gradient">
